  ...
  return chatUser ? (
    <div className={`chat-box ${chatVisible ? '' : 'hidden'}`}>
      ...
      <div className="chat-input">
        <input onChange={(e) => setInput(e.target.value)} value={input} onKeyDown={(e) => { if (e.key === 'Enter') { sendMessage(); } }} type="text" placeholder='Send a message' />
    ...
    : <div className={`chat-welcome ${chatVisible ? '' : 'hidden'}`}>
      ...
      <p> Chat Whenever and However You Want, Mate! </p>
    </div>
}
